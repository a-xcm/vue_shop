<template>
  <div>
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          ...
          v-model="queryInfo.query" @keyup.enter.native="getUserList"
    ...
    <!-- 分配角色的对话框 -->
    <el-dialog title="分配角色" :visible.sync="setRoleDialogVisable" width="30%"
    @close="setRoleDialogClosed">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="saveRoleInfo">确 认</el-button>
      </span>
    </el-dialog>
  </div>
</template>
